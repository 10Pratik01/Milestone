  ...
  return (
    <div className={sidebarClassNames}>
      <div className="flex h-full w-full flex-col justify-start">
        ...
        {/* Team */}
        <Link href={"/"}>
          <div className="flex justify-between border-b-[1.5px] border-gray-200 dark:border-gray-700 ">
  ...
  return (
    <Link href={href} className="2-full">
      <div
        ...
        onMouseEnter={() => setBlueBar(!blueBar)}
        onMouseLeave={() => setBlueBar(!blueBar)}
      >
        {isActive && (
          <div
            className={`absolute  top-0 left-0 h-full bg-blue-500 ${blueBar ? "w-2.5 transition-all ease-linear transition-150ms" : "w-[5px]"}`}
          />
        )}
